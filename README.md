...
- SFTP连接池文件传输组件，基于JSch+Commons Pool2实现，支持文件上下传、删除、目录创建
...
| boot-common-sftp    | SFTP 连接池管理，文件上传下载、删除、自动建目录 | 依赖 JSch、Commons Pool2  |
