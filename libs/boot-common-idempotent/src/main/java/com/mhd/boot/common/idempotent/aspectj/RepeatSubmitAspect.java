package com.mhd.boot.common.idempotent.aspectj;
...
public class RepeatSubmitAspect {
    private static final String PREFIX = "global:repeat_submit:";
    ...
    public void doBefore(JoinPoint point, RepeatSubmit repeatSubmit) throws Throwable {
        ...
        // 唯一标识（指定key + url + 消息头）
        String cacheRepeatKey = PREFIX + url + submitKey;
    ...
    public void doAfterReturning(JoinPoint joinPoint, RepeatSubmit repeatSubmit, Object jsonResult) {
        if (jsonResult instanceof BaseResponse<?> r) {
            try {
                ...
                if (ErrorCodeEnum.SUCCESS.getCode().equals(r.getCode())) {
                    return;
                }
