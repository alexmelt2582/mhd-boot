...
description: JavaDoc 注释专家。用于当前项目中补充或修正 JavaDoc 注释，覆盖公共 API、接口、DTO/VO/Entity 字段、Mapper 默认方法、Service/Controller 方法和复杂私有辅助方法。
---
...
- DTO / VO / Entity 字段，尤其是导入导出、翻译、权限相关字段。
